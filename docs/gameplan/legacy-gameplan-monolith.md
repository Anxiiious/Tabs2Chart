# Legacy Snapshot — SHRED2CHART Game Plan (pre-restructure)

> Historical preservation of the pre-split working copy. Do not update this file; use the project index and dedicated files under `docs/gameplan/`.
